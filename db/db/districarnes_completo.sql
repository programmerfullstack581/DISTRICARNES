-- ============================================================
--  PARTE 1/3: ESQUEMA PRINCIPAL + DATOS (districarnes_navarro.sql)
-- ============================================================
...
(1, 'Proveedor genÃ©rico', NULL, NULL, NULL, NULL) ON CONFLICT DO NOTHING;
...
(21, 'HÃ­gado', 12000.00, 8000.00, 3000000.00, '', '2025-10-05', 'L20251012-0B7DB8', 50, 1, 5, '/static/images/products/prod_68ebf6370ee2a9.09330560.jpeg', true, 'Unidad', 'HÃ­gado', 50, 'Unidad', 12000.00, 5),
...
(23, 'CorazÃ³n', 13000.00, 8500.00, 32.00, '', '2025-10-05', 'L20251012-07DEE5', 50, 1, 5, '/static/images/products/prod_68ebf6676c3a31.82693452.webp', true, 'Unidad', 'CorazÃ³n', 50, 'Unidad', 13000.00, 5),
...
(25, 'RiÃ±Ã³n', 14000.00, 9000.00, 1.00, '', '2025-10-05', 'L20251012-0F2FAB', 50, 1, 5, '/static/images/products/prod_68ebf68eecd784.84489479.jpg', true, 'Unidad', 'RiÃ±Ã³n', 50, 'Unidad', 14000.00, 5),
...
(1, '92T721159F630974S', 'comprador@gmail.com', 'comprador', 'COMPLETED', 14000.00, '0', '{"street":"Avenida Calle cartagena SN 23","city":"Cartagena De Indias","dept":"BolÃ­var","zip":"","notes":""}', '{"envio1":"sabado","envio2":"lunes"}', '2025-10-13 11:27:21'),
(2, '6DS76703S2114415R', 'comprador@gmail.com', 'comprador', 'COMPLETED', 45000.00, '0', '{"street":"Avenida Calle cartagena SN 23","city":"Cartagena De Indias","dept":"BolÃ­var","zip":"","notes":""}', '{"envio1":"sabado","envio2":"lunes"}', '2025-10-13 14:41:57'),
(3, '00V78098FH534732J', 'juanpiayola@gmail.com', 'juan pablo', 'PROCESSING', 46000.00, '0', '{"street":"Avenida Calle cartagena SN 23","city":"Cartagena De Indias","dept":"BolÃ­var","zip":"","notes":""}', '{"envio1":"sabado","envio2":"lunes"}', '2025-10-13 14:52:00'),
(4, '97598458EK347352A', 'juanpiayola@gmail.com', 'juan pablo', 'PENDING', 14000.00, '0', '{"street":"Avenida Calle cartagena SN 23","city":"Cartagena De Indias","dept":"BolÃ­var","zip":"","notes":""}', '{"envio1":"sabado","envio2":"lunes"}', '2025-10-13 16:26:25'),
(5, '06U33077V6744505L', 'comprador@gmail.com', 'comprador', '0', 14000.00, '0', '{"street":"Avenida Calle cartagena SN 23","city":"Cartagena De Indias","dept":"BolÃ­var","zip":"","notes":""}', '{"envio1":"sabado","envio2":"lunes"}', '2025-11-07 15:49:14') ON CONFLICT DO NOTHING;
...
-- ============================================
-- 6. CONFIGURACIÃ“N DE SECUENCIAS
-- ============================================
...
-- ============================================
-- Â¡SCRIPT COMPLETADO EXITOSAMENTE!
-- ============================================
-- ============================================================
--  PARTE 2/3: TABLA DE RESEÑAS (resenas.sql)
-- ============================================================

-- Tabla de ReseÃ±as para Productos
...
-- Ãndice para bÃºsquedas rÃ¡pidas de reseÃ±as por producto
CREATE INDEX IF NOT EXISTS idx_resenas_producto ON resenas(id_producto);

-- Ãndice para bÃºsquedas rÃ¡pidas de reseÃ±as por usuario
CREATE INDEX IF NOT EXISTS idx_resenas_usuario ON resenas(id_usuario);

-- ============================================================
--  PARTE 3/3: FACTURAS Y MIGRACION DE PEDIDOS (facturas_sql.txt)
-- ============================================================
