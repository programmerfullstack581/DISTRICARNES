...
<body class=" bg-black text-white ">
    ...
    <header class="header ">
        ...
        <div class="mobile-header" id="mobileHeader">
            ...
            <div class="mh-right">
                <a href="" class="mh-icon mh-cart" aria-label="Carrito">
            ...
            <aside class="mobile-drawer" id="mobileDrawer" style="z-index:10000">
                ...
                <div id="drawerUserLogged" style="display:none;padding:8px 12px;gap:10px;flex-direction:column;align-items:stretch">
                    <a href="../perfil.html" style="background:#111;color:#fff;border:1px solid #222;border-radius:10px;padding:10px 14px;text-decoration:none;font-weight:700;display:block;width:100%;text-align:center"><i class="fas fa-user"></i> Mi Perfil</a>
        ...
        <div class="header-content ">
            ...
            <div id="quickLinks" class="ml-actions">
                <a id="cartButton" class="ml-icon-btn ml-icon-bounce" href="#"
                    aria-label="Carrito">
                    <i class="bi bi-cart"></i>
