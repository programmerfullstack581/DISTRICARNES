...
- Backend
  - Factura HTML: [backend/php/order_invoice.php](file:///c:/Users/progr/DISTRICARNES/backend/php/order_invoice.php) — muestra empresa/cliente, ítems, totales, estado legible, QR y “Factura enviada a: …”.
  - Guardado de órdenes: [backend/php/orders_save.php](file:///c:/Users/progr/DISTRICARNES/backend/php/orders_save.php) (PayPal) y [backend/php/orders_save_pending.php](file:///c:/Users/progr/DISTRICARNES/backend/php/orders_save_pending.php) (otros métodos).
  - Captura de PayPal: [backend/php/capture_paypal_order.php](file:///c:/Users/progr/DISTRICARNES/backend/php/capture_paypal_order.php) (si aplica).
  - Envío de factura por email: [backend/php/send_invoice_email.php](file:///c:/Users/progr/DISTRICARNES/backend/php/send_invoice_email.php) (SMTP configurable).
  - Cotización de envío: [backend/php/shipping_quote.php](file:///c:/Users/progr/DISTRICARNES/backend/php/shipping_quote.php).
  - Consulta de usuario por email (foto): [backend/php/get_user_by_email.php](file:///c:/Users/progr/DISTRICARNES/backend/php/get_user_by_email.php).
  - CRUD de ventas (admin): [backend/php/admin_sales_crud.php](file:///c:/Users/progr/DISTRICARNES/backend/php/admin_sales_crud.php).
  - Configuración de empresa: [backend/php/factus_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/factus_config.php).
  - Configuración de PayPal: [backend/php/paypal_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/paypal_config.php).
  - Configuración de correo: [backend/php/email_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/email_config.php).
...
2) Carrito y resumen
- Eventos `cart:updated` sincronizan componentes. El total incluye envío según [shipping_quote.php](file:///c:/Users/progr/DISTRICARNES/backend/php/shipping_quote.php).
...
- Guardar orden PayPal — [orders_save.php](file:///c:/Users/progr/DISTRICARNES/backend/php/orders_save.php)
  - Entrada JSON (resumen): `{ paypal_id, status, total, delivery, address, schedule, items[], user{email,name} }`
  - Respuesta: `{ ok: true, order_id }`

- Guardar orden PENDING — [orders_save_pending.php](file:///c:/Users/progr/DISTRICARNES/backend/php/orders_save_pending.php)
  - Entrada: `{ total, delivery, address, schedule, pay, items[], user{email,name} }`
  - Respuesta: `{ ok: true, order_id }`

- Factura — [order_invoice.php](file:///c:/Users/progr/DISTRICARNES/backend/php/order_invoice.php)
  - GET `?order_id=ID[&print=1]` — imprime si `print=1`.

- Envío de factura por correo — [send_invoice_email.php](file:///c:/Users/progr/DISTRICARNES/backend/php/send_invoice_email.php)
  - Entrada: `{ order_id, to }` — usa SMTP según configuración.

- CRUD de ventas (admin) — [admin_sales_crud.php](file:///c:/Users/progr/DISTRICARNES/backend/php/admin_sales_crud.php)
...
### Datos de la empresa
- Centralizados en [factus_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/factus_config.php). Definen nombre, NIT, correo, teléfono, dirección y moneda.

### PayPal
- Variables de entorno usadas por [paypal_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/paypal_config.php):
...
### SMTP/Email
- Variables de [email_config.php](file:///c:/Users/progr/DISTRICARNES/backend/php/email_config.php):
  - `SMTP_HOST`, `SMTP_PORT`, `SMTP_SECURE` (`tls`/`ssl`), `SMTP_USER`, `SMTP_PASS`, `MAIL_FROM`, `MAIL_FROM_NAME`.
- Envío implementado en [smtp_mailer.php](file:///c:/Users/progr/DISTRICARNES/backend/php/smtp_mailer.php).
...
- Estados legibles en factura (mapeo de `0` a “Pendiente”). Ver [order_invoice.php](file:///c:/Users/progr/DISTRICARNES/backend/php/order_invoice.php).
