...
--------------------------------------
Edita el archivo `backend/php/core/email_config.php`:
...
-------------------------
Envía un POST a `backend/php/tests/test_mail.php` con el parámetro `to` (correo destino). Ejemplo en Postman/curl:

POST http://localhost/DISTRICARNES/backend/php/tests/test_mail.php
...
--------------------------------------------------
Mientras configuras SMTP, el enlace de recuperación se guarda en `backend/php/auth/reset_links.log`.
